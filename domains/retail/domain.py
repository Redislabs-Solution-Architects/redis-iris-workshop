...
from domains.retail.data_generator import DEMO_CUSTOMER, generate_demo_data
from domains.retail.prompt import build_system_prompt
from domains.retail.schema import ENTITY_SPECS
...
class ElectrohubDomain:
    manifest = DomainManifest(
        ...
        generated_models_module="domains.retail.generated_models",
        generated_models_path="domains/retail/generated_models.py",
        output_dir="output/retail",
        branding=BrandingConfig(
            ...
            logo_path="domains/retail/assets/logo.png",
            demo_steps=[
        ...
        namespace=NamespaceConfig(
            redis_prefix="retail",
            dataset_meta_key="retail:meta:dataset",
            checkpoint_prefix="retail:checkpoint",
            checkpoint_write_prefix="retail:checkpoint_write",
